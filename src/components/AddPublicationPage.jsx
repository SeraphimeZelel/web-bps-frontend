...
export default function AddPublicationPage(){
  ...
  const handleSubmit = async (e) => {
    ...
    const newPublication = {
      title,
      releaseDate,
      description : description || "Deskripsi seadanya." ,
      coverUrl
    };
    ...
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label
            htmlFor="title"
            className="block text-sm font-medium text-gray-700 mb-1">Judul
          </label>
          ...
          <input
            ...
            placeholder="Contoh: Indikator Ekonomi Aceh 2025"
            required
          />
        </div>
        <div>
          <label
           htmlFor="description"
           className="block text-sm font-medium text-gray-700 mb-1">Deskripsi
           </label>
           ...
           className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-sky-500 focus:border-sky-500"
           placeholder="Contoh : Publikasi ini membahas ... (isi sendiri)"
           rows={4}
           />
        ...
        <div>
          <label
            htmlFor="releaseDate"
            className="block text-sm font-medium text-gray-700 mb-1"> Tanggal Rilis
          </label>
        ...
        <div>
          <label
            htmlFor="cover"
            className="block text-sm font-medium text-gray-700 mb-1">Sampul (Gambar)
          </label>
          <input
            type="file"
            id="cover"
        ...
        <div className="flex justify-end">
          ...
          <button
            type="submit"
            className="bg-sky-700 hover:bg-sky-800 text-white font-bold py-2 px-6 rounded-lgtransition-colors duration-300">Tambah
          </button>
        </div>
      </form>
    </div>
